...
// for (let i = 0; i < specialMode.length + 9 * 2; i++) {
//   let length = Helper.randInt(1, 3);
//   let combination = "";
//   for (let i = 0; i < length; i++) {
//     let char = specialMode[Helper.randInt(0, specialMode.length - 1)];
//     combination += char;
//   }
//   Combinations.push(combination);
// }
// console.log(Combinations.sort((a, b) => b.length - a.length));
