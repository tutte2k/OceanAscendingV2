...
class Chtullie extends Octopus {
  constructor(game) {
    ...
    this.data = {
      8: this.datta.splice(0, 20).reverse(),
      7: this.datta.splice(0, 20).reverse(),
      6: this.datta.splice(0, 20).reverse(),
      5: this.datta.splice(0, 20).reverse(),
      4: this.datta.splice(0, 20).reverse(),
      3: this.datta.splice(0, 20).reverse(),
      2: this.datta.splice(0, 20).reverse(),
      1: this.datta.splice(0, 20).reverse(),
      0: this.datta.splice(0, 20).reverse(),
    };
